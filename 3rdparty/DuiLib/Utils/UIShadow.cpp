...
#ifdef __REPAIR_BY_HU__
			SetWindowPos(pThis->m_hWnd, 0,WndRect.left - pThis->m_rcShadowCorner.left, WndRect.top - pThis->m_rcShadowCorner.top,
				0, 0, SWP_NOSIZE | SWP_NOACTIVATE);
#else
			SetWindowPos(pThis->m_hWnd, 0, WndRect.left - pThis->m_nSize, WndRect.top - pThis->m_nSize, 0, 0, SWP_NOSIZE | SWP_NOACTIVATE);
#endif // __REPAIR_BY_HU__	
		}
		else {

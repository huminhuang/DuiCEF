...
namespace DuiLib {
	...
	CControlUI* CDialogBuilder::CreateEx(BYTE* pXmlByte, DWORD dwSize, int encoding, IDialogBuilderCallback* pCallback /*= NULL*/, CPaintManagerUI* pManager /*= NULL*/, CControlUI* pParent /*= NULL*/)
	{
		m_xml.LoadFromMem(pXmlByte, dwSize, encoding);
		return Create(pCallback, pManager, pParent);
	}
